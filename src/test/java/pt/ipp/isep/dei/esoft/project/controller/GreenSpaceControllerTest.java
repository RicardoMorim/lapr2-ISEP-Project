...
class GreenSpaceControllerTest {
    ...
    void setUp() {
        ...
        greenSpace = new GreenSpace("Park", new Address("Street", "City", "Zip"), 500.0, Type.GARDEN, new Email("abc@gmail.com"));
    }

    @Test
    void addGreenSpaceByNameAddressAreaType_success() {
        controller.addGreenSpace("Park", new Address("Street", "City", "Zip"), 500.0, Type.GARDEN, new Email("abc@gmail.com"));
    ...
    void addGreenSpaceByNameAddressAreaType_duplicateName() {
        controller.addGreenSpace("Park", new Address("Street", "City", "Zip"), 500.0, Type.GARDEN, new Email("abc@gmail.com"));
        assertThrows(IllegalArgumentException.class, () -> controller.addGreenSpace("Park", new Address("Street", "City", "Zip"), 500.0, Type.GARDEN, new Email("abc@gmail.com")));
    }

    @Test
    void addGreenSpaceByNameAddressAreaType_duplicateAddress() {
        controller.addGreenSpace("Park", new Address("Street", "City", "Zip"), 500.0, Type.GARDEN, new Email("abc@gmail.com"));
        assertThrows(IllegalArgumentException.class, () -> controller.addGreenSpace("Park2", new Address("Street", "City", "Zip"), 500.0, Type.GARDEN, new Email("abc@gmail.com")));
    }
